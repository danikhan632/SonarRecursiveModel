#!/usr/bin/env python3
"""
Train LLaDA-TRM Hybrid Model

This script implements phased training for the hybrid architecture:
1. Phase 1: Warm-up - Train only the recursive head with frozen LLaDA
2. Phase 2: Fine-tuning - Jointly fine-tune with optional backbone unfreezing
3. Phase 3: CoT specialization - Train on reasoning datasets
...
def parse_args():
    ...
    p.add_argument("--output_dir", type=str, default="./outputs/llada_trm_hybrid",
...
def main():
    ...
    # Create model
    print(f"Creating LLaDA-TRM hybrid model...")
    model_config = {
